(custom-set-variables
 ...
 '(package-selected-packages
   '(lispy markdown-mode org-download eno vertico which-key nerd-icons erlang format-sql sqlformat magit-delta rust-mode cape envrc git-gutter-fringe git-gutter lsp-ui plan9-theme undo-hl vundo evil-visualstar perspective deft org-roam org-superstar visual-fill-column doom-modeline minions dired-rainbow all-the-icons-dired dmenu json-mode protobuf-mode yaml-mode nix-mode corfu openwith lua-mode wgrep embark-consult 0x0 org-fancy-priorities org-autolist org-bullets evil-org lsp-mode elm-mode haskell-mode elixir-mode evil-collection evil pdf-tools auctex rainbow-delimiters forge magit direnv embark-collect embark marginalia orderless consult-project-extra dired-single sudo-edit vertico-posframe dired-posframe which-key-posframe ivy-posframe posframe powerline doom-themes vterm)))
(custom-set-faces
